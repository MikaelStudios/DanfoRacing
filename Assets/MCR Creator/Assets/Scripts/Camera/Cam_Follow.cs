...
public class Cam_Follow : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (!b_Pause && target && GlobalDebugger.instance)
        {
            distance = GlobalDebugger.instance.distance;
            height = GlobalDebugger.instance.height;
            ...
            transform.LookAt(target.position + GlobalDebugger.instance.camOffset);
        }
    }
